...
*/
$MONGO["servers"][$i]["mongo_name"] = "correctarium";//mongo server name
...
$MONGO["servers"][$i]["control_users"]["btkm"] = "Fytdnk23";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
